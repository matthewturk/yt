...
from yt.frontends.enzo_e_octree.api import EnzoEOctreeDataset
...
data_dir_load = partial(data_dir_load, kwargs={"hint": "EnzoEOctreeDataset"})


@requires_module("h5py")
@requires_file(hello_world)
def test_EnzoEDataset():
    assert isinstance(data_dir_load(hello_world), EnzoEOctreeDataset)
